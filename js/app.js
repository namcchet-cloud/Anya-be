import { VERSION } from './core/build.js?v=6.2.0';
import { start, near, features, issues, report } from './core/runtime.js?v=6.2.0';
import { initI18n } from './core/i18n.js?v=6.2.0';
import { initMotion } from './features/motion.js?v=6.2.0';
import { initNavigation } from './features/navigation.js?v=6.2.0';
...
try {
  ...
  lazy('gallery', document.getElementById('gallery'), async () => (await import('./features/gallery.js?v=kivat-1.0')).initGallery(content));
  lazy('music', document.getElementById('playlist'), async () => (await import('./features/music/index.js?v=6.2.0')).initMusic(content));
