...
const VERSION='raven-kivat-v1.9';
const DURATION=8.15;
let current=null;
...
const CSS=`
:host{all:initial}*{box-sizing:border-box}.layer{position:fixed;inset:0;z-index:2147482000;overflow:hidden;isolation:isolate;font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif;color:#fff;touch-action:none}.backdrop{position:absolute;inset:0;background:radial-gradient(circle at 50% 52%,rgba(72,8,22,.32),rgba(4,3,7,.93) 58%,#020205 100%);opacity:0;animation:bgIn .48s ease forwards;backdrop-filter:brightness(.34) saturate(.6)}.backdrop:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 50% 50%,transparent 24%,rgba(0,0,0,.64) 92%)}canvas{position:absolute;inset:0;width:100%;height:100%;display:block;z-index:4}.avatar{position:absolute;z-index:3;border-radius:50%;overflow:hidden;box-shadow:0 0 0 1px #fff3,0 0 30px #d22a3a40;opacity:.95;transform-origin:center}.avatar img{display:block;width:100%;height:100%;object-fit:cover;background:#17151a}.avatar.bitten{animation:biteHit .34s cubic-bezier(.2,.8,.2,1)}.avatar:after{content:"";position:absolute;inset:-18%;border:2px solid transparent;border-radius:50%}.avatar.bitten:after{animation:biteRing .4s ease-out}.hud{position:absolute;z-index:20;top:max(14px,env(safe-area-inset-top));left:max(14px,env(safe-area-inset-left));right:max(14px,env(safe-area-inset-right));display:flex;justify-content:space-between;align-items:center;pointer-events:none}.hud b{font:800 10px/1.2 inherit;letter-spacing:.16em;color:#e6dadd;text-shadow:0 1px 12px #000}.hud button{pointer-events:auto;border:1px solid #fff3;background:#0b080bc4;color:#f7ecee;padding:9px 12px;border-radius:999px;font:700 10px/1 inherit;letter-spacing:.08em}.status{position:absolute;z-index:7;left:50%;bottom:max(18px,env(safe-area-inset-bottom));transform:translateX(-50%);font:700 9px/1.2 inherit;letter-spacing:.18em;color:#c0b2b5;white-space:nowrap;text-shadow:0 1px 10px #000}.impact{position:absolute;z-index:9;left:50%;top:50%;width:44vmin;aspect-ratio:1;border:2px solid #ff5266;border-radius:50%;box-shadow:0 0 90px #ed203cb0,inset 0 0 60px #ffe1ab24;opacity:0;transform:translate(-50%,-50%) scale(.18);pointer-events:none}.impact.go{animation:impact .34s ease-out}.flash{position:absolute;inset:0;z-index:11;background:#fff;opacity:0;mix-blend-mode:screen;pointer-events:none}.flash.go{animation:flash .24s ease-out}.chains{position:absolute;inset:0;z-index:13;pointer-events:none;opacity:0;overflow:hidden}.chains::before{content:'';position:absolute;inset:0;background:rgba(2,1,3,.16);opacity:0;transition:opacity .1s ease}.chains.lock{opacity:1}.chains.lock::before{opacity:1}.slot{position:absolute;left:50%;top:50%;width:150vmax;height:150vmax;transform:translate(-50%,-50%);transform-origin:center;will-change:transform}.slot img{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;opacity:0;will-change:transform,opacity;filter:drop-shadow(0 4px 5px #000) drop-shadow(0 0 9px #e52b3d35);transform:translate(calc(var(--fx) + var(--sx)),calc(var(--fy) + var(--sy))) scaleX(var(--flip)) scale(1.08)}.chains.lock .slot img{animation:rushGrid .48s cubic-bezier(.15,.8,.2,1) var(--d) both}.chains.tight .slot{animation:tight .18s ease-in-out infinite alternate}.chains.break .slot img{animation:snapGrid .38s cubic-bezier(.22,.75,.2,1) forwards!important}.slot:nth-child(1){--flip:1;--fx:-95.0vmin;--fy:-95.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-10deg;--d:0.000s}.slot:nth-child(2){--flip:1;--fx:-85.0vmin;--fy:-85.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-8deg;--d:0.006s}.slot:nth-child(3){--flip:1;--fx:-75.0vmin;--fy:-75.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-6deg;--d:0.012s}.slot:nth-child(4){--flip:1;--fx:-65.0vmin;--fy:-65.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-4deg;--d:0.018s}.slot:nth-child(5){--flip:1;--fx:-55.0vmin;--fy:-55.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-2deg;--d:0.024s}.slot:nth-child(6){--flip:1;--fx:-45.0vmin;--fy:-45.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-10deg;--d:0.030s}.slot:nth-child(7){--flip:1;--fx:-35.0vmin;--fy:-35.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-8deg;--d:0.036s}.slot:nth-child(8){--flip:1;--fx:-25.0vmin;--fy:-25.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-6deg;--d:0.042s}.slot:nth-child(9){--flip:1;--fx:-15.0vmin;--fy:-15.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-4deg;--d:0.048s}.slot:nth-child(10){--flip:1;--fx:-5.0vmin;--fy:-5.0vmin;--sx:-34vw;--sy:34vh;--bx:-48vw;--by:48vh;--br:-2deg;--d:0.054s}.slot:nth-child(11){--flip:1;--fx:5.0vmin;--fy:5.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-10deg;--d:0.060s}.slot:nth-child(12){--flip:1;--fx:15.0vmin;--fy:15.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-8deg;--d:0.066s}.slot:nth-child(13){--flip:1;--fx:25.0vmin;--fy:25.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-6deg;--d:0.072s}.slot:nth-child(14){--flip:1;--fx:35.0vmin;--fy:35.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-4deg;--d:0.078s}.slot:nth-child(15){--flip:1;--fx:45.0vmin;--fy:45.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-2deg;--d:0.084s}.slot:nth-child(16){--flip:1;--fx:55.0vmin;--fy:55.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-10deg;--d:0.090s}.slot:nth-child(17){--flip:1;--fx:65.0vmin;--fy:65.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-8deg;--d:0.096s}.slot:nth-child(18){--flip:1;--fx:75.0vmin;--fy:75.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-6deg;--d:0.102s}.slot:nth-child(19){--flip:1;--fx:85.0vmin;--fy:85.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-4deg;--d:0.108s}.slot:nth-child(20){--flip:1;--fx:95.0vmin;--fy:95.0vmin;--sx:-34vw;--sy:34vh;--bx:48vw;--by:-48vh;--br:-2deg;--d:0.114s}.slot:nth-child(21){--flip:-1;--fx:-95.0vmin;--fy:95.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:10deg;--d:0.025s}.slot:nth-child(22){--flip:-1;--fx:-85.0vmin;--fy:85.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:8deg;--d:0.031s}.slot:nth-child(23){--flip:-1;--fx:-75.0vmin;--fy:75.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:6deg;--d:0.037s}.slot:nth-child(24){--flip:-1;--fx:-65.0vmin;--fy:65.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:4deg;--d:0.043s}.slot:nth-child(25){--flip:-1;--fx:-55.0vmin;--fy:55.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:2deg;--d:0.049s}.slot:nth-child(26){--flip:-1;--fx:-45.0vmin;--fy:45.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:10deg;--d:0.055s}.slot:nth-child(27){--flip:-1;--fx:-35.0vmin;--fy:35.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:8deg;--d:0.061s}.slot:nth-child(28){--flip:-1;--fx:-25.0vmin;--fy:25.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:6deg;--d:0.067s}.slot:nth-child(29){--flip:-1;--fx:-15.0vmin;--fy:15.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:4deg;--d:0.073s}.slot:nth-child(30){--flip:-1;--fx:-5.0vmin;--fy:5.0vmin;--sx:-34vw;--sy:-34vh;--bx:48vw;--by:48vh;--br:2deg;--d:0.079s}.slot:nth-child(31){--flip:-1;--fx:5.0vmin;--fy:-5.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:10deg;--d:0.085s}.slot:nth-child(32){--flip:-1;--fx:15.0vmin;--fy:-15.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:8deg;--d:0.091s}.slot:nth-child(33){--flip:-1;--fx:25.0vmin;--fy:-25.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:6deg;--d:0.097s}.slot:nth-child(34){--flip:-1;--fx:35.0vmin;--fy:-35.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:4deg;--d:0.103s}.slot:nth-child(35){--flip:-1;--fx:45.0vmin;--fy:-45.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:2deg;--d:0.109s}.slot:nth-child(36){--flip:-1;--fx:55.0vmin;--fy:-55.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:10deg;--d:0.115s}.slot:nth-child(37){--flip:-1;--fx:65.0vmin;--fy:-65.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:8deg;--d:0.121s}.slot:nth-child(38){--flip:-1;--fx:75.0vmin;--fy:-75.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:6deg;--d:0.127s}.slot:nth-child(39){--flip:-1;--fx:85.0vmin;--fy:-85.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:4deg;--d:0.133s}.slot:nth-child(40){--flip:-1;--fx:95.0vmin;--fy:-95.0vmin;--sx:-34vw;--sy:-34vh;--bx:-48vw;--by:-48vh;--br:2deg;--d:0.139s}.shards{position:absolute;inset:0;z-index:14;pointer-events:none}.shard{position:absolute;left:50%;top:50%;width:7px;height:16px;border-radius:3px;background:linear-gradient(#e2e2e2,#676767);opacity:0;box-shadow:0 0 5px #fff3;transform:translate(-50%,-50%) rotate(var(--r))}.shards.go .shard{animation:shard .5s cubic-bezier(.1,.74,.15,1) var(--d) forwards}.shard:nth-child(1){--x:-42vw;--y:-32vh;--r:48deg;--d:0s}.shard:nth-child(2){--x:39vw;--y:-30vh;--r:-51deg;--d:.02s}.shard:nth-child(3){--x:-47vw;--y:20vh;--r:95deg;--d:.04s}.shard:nth-child(4){--x:45vw;--y:24vh;--r:18deg;--d:.06s}.shard:nth-child(5){--x:-18vw;--y:-42vh;--r:120deg;--d:.08s}.shard:nth-child(6){--x:17vw;--y:43vh;--r:-102deg;--d:.1s}.shard:nth-child(7){--x:-32vw;--y:37vh;--r:66deg;--d:.04s}.shard:nth-child(8){--x:34vw;--y:-38vh;--r:-76deg;--d:.07s}.layer.exit{animation:out .42s ease forwards}@keyframes bgIn{to{opacity:1}}@keyframes biteHit{0%{transform:scale(1)}35%{transform:scale(.91) translateX(-2px);filter:brightness(1.35)}70%{transform:scale(1.04) translateX(2px)}100%{transform:scale(1)}}@keyframes biteRing{0%{border-color:#ff384f;transform:scale(.72);opacity:1}100%{border-color:#ff384f00;transform:scale(1.38);opacity:0}}@keyframes impact{0%{opacity:0;transform:translate(-50%,-50%) scale(.18)}20%{opacity:.96}100%{opacity:0;transform:translate(-50%,-50%) scale(1.35)}}@keyframes flash{0%{opacity:0}25%{opacity:.8}100%{opacity:0}}@keyframes rushGrid{0%{opacity:.15;transform:translate(calc(var(--fx) + var(--sx)),calc(var(--fy) + var(--sy))) scaleX(var(--flip)) scale(1.08)}12%{opacity:1}100%{opacity:1;transform:translate(var(--fx),var(--fy)) scaleX(var(--flip)) scale(1.08)}}@keyframes tight{from{transform:translate(-50%,-50%) rotate(var(--r)) scale(1)}to{transform:translate(-50%,-50%) rotate(var(--r)) scale(.965)}}@keyframes snapGrid{0%{opacity:1;transform:translate(var(--fx),var(--fy)) scaleX(var(--flip)) scale(1.08)}18%{filter:brightness(2.1) drop-shadow(0 0 14px #fff7)}100%{opacity:0;transform:translate(calc(var(--fx) + var(--bx)),calc(var(--fy) + var(--by))) rotate(var(--br)) scaleX(var(--flip)) scale(1.02)}}@keyframes shard{0%{opacity:0;transform:translate(-50%,-50%) rotate(var(--r)) scale(.6)}10%{opacity:1}100%{opacity:0;transform:translate(calc(-50% + var(--x)),calc(-50% + var(--y))) rotate(calc(var(--r) + 240deg)) scale(1.3)}}@keyframes out{to{opacity:0}}@media(max-width:720px){.hud b{font-size:9px}.status{font-size:8px;bottom:max(12px,env(safe-area-inset-bottom))}.slot{width:165vmax;height:165vmax}}
`;

function html(chain,src,rect){const size=Math.max(46,Math.min(92,rect.width||58)),left=Math.max(12,rect.left),top=Math.max(12,rect.top);return `<div class="layer"><div class="backdrop"></div><div class="avatar" style="left:${left}px;top:${top}px;width:${size}px;height:${size}px"><img src="${src}" alt=""></div><canvas></canvas><div class="impact"></div><div class="flash"></div><div class="chains">${Array.from({length:40},()=>`<span class="slot"><img src="${chain}" alt=""></span>`).join('')}</div><div class="shards">${Array.from({length:8},()=>'<i class="shard"></i>').join('')}</div><header class="hud"><b>RAVEN LIN // KIVAT EASTER EGG</b><button data-skip type="button">BỎ QUA ↗</button></header><div class="status">KIVAT BELT // ORIGINAL FBX GEOMETRY</div></div>`}
